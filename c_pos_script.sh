...
####                       MAKE IN4
echo "resname POPG and not same residue as within 0.4 of group 1 " | gmx select -f $dir/$TRAJ.xtc -s $dir/$TOPOL.tpr -on $dir/PG_notin4.ndx -b 200000 -e 200000
echo "q" | gmx make_ndx -f $dir/fullsys.gro -o $dir/index.ndx
...
q
EOF
echo "resname POPE and not same residue as within 0.4 of group 1 " | gmx select -f $dir/$TRAJ.xtc -s $dir/$TOPOL.tpr -on $dir/PE_notin4.ndx -b 200000 -e 200000
echo "q" | gmx make_ndx -f $dir/fullsys.gro -o $dir/index.ndx
...
echo "resname POPG and same residue as within 0.4 of group 1 " | gmx select -f $dir/$TRAJ.xtc -s $dir/$TOPOL.tpr -on $dir/PG_in4.ndx -b 200000 -e 200000
echo "q" | gmx make_ndx -f $dir/fullsys.gro -o $dir/index.ndx
...
q
EOF
echo "resname POPE and same residue as within 0.4 of group 1 " | gmx select -f $dir/$TRAJ.xtc -s $dir/$TOPOL.tpr -on $dir/PE_in4.ndx -b 200000 -e 200000
echo "q" | gmx make_ndx -f $dir/fullsys.gro -o $dir/index.ndx
...
q
EOF
gmx make_ndx -f $dir/fullsys.gro -o $dir/POPE_sn1.ndx << EOF
14 & a C31
14 & a C32
14 & a C33
14 & a C34
